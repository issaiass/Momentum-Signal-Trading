...
Current count: **359 tests**, all passing. Every test file and class has a docstring explaining
...
Worth repeating because it's easy to forget once a suite is green: **359 passing tests confirm
